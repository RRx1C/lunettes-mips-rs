...
fn main() {
    ...
    [   0x08010008, 0x0C104000, 0x11090010, 0x16110020, 0x18A00030, 0x1CA80040, 0x214A0010, 0x25520020,
        ...
        0x73762802, 0x704A0004, 0x704A0005, 0x70A21020, 0x70A21021, 0x7000017F, 0x7C050004];

    // let instruction = disassembler.disassemble(0x70000020, 0x40000).unwrap();
    // let str = String::from_iter(instruction.string.data());
    // let instruction_machine_code = instruction.machine_code.to_le_bytes();
